...
![Asset Store](https://blog-1301118239.cos.eu-frankfurt.myqcloud.com/Images/2017012901.png)

作为一个洁癖当然不会随便的把 Example 和 README 什么的导入进来了～想看的话可以到另一个工程里看一看

![导入](https://blog-1301118239.cos.eu-frankfurt.myqcloud.com/Images/2017012902.png)
...
![AssetBundles](https://blog-1301118239.cos.eu-frankfurt.myqcloud.com/Images/2017012903.png)
...
![场景完成](https://blog-1301118239.cos.eu-frankfurt.myqcloud.com/Images/2017020101.png)
...
![生成的文件](https://blog-1301118239.cos.eu-frankfurt.myqcloud.com/Images/2017020102.png)

生成好的文件如上图所示，`scene_4`很小只有100K左右，查看其 manifest 文件可以得出以下依赖关系（没装 visio 之类的随便用一个 vscode 插件画了一下）

![依赖关系](https://blog-1301118239.cos.eu-frankfurt.myqcloud.com/Images/2017020103.png)
